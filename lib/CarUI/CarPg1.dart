...
class Car_design1 extends StatefulWidget {
  const Car_design1({super.key});

  @override
  State<Car_design1> createState() => _Car_design1State();
}

class _Car_design1State extends State<Car_design1> {
  @override
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    CircleAvatar(
                      radius: 18,
                      backgroundImage: AssetImage("assets/jason.jpg"),
                    )
                  ],
                ),
              )
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                            ...
                            color: Colors.white,
                            child: Image(
                                image: AssetImage("assets/mercedeslogo.png"))),
                        SizedBox(
                          height: 5,
                        ),
                        Text(
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                            ...
                            color: Colors.white,
                            child: Image(
                                image: AssetImage("assets/porschelogo.jpeg"))),
                        SizedBox(
                          height: 5,
                        ),
                        Text(
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                            ...
                            color: Colors.white,
                            child: Image(
                                image: AssetImage("assets/renaultlogo.png"))),
                        SizedBox(
                          height: 5,
                        ),
                        Text(
