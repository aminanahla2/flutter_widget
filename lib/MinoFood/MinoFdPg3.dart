import 'package:amina_flutter/MinoFood/MinoFdpg2.dart';
                              ...
                              Column(
                                children: [
                                  Container(
                                    ...
                                    height: 80,
                                    decoration: BoxDecoration(
                                        image: DecorationImage(image: AssetImage("assets/img5.jpeg"),fit: BoxFit.cover),
                                  ...
                                  Container(
                                    ...
                                    height: 80,
                                    decoration: BoxDecoration(
                                        image: DecorationImage(image: AssetImage("assets/sumrjuc.webp"),fit: BoxFit.cover),
                                        borderRadius: BorderRadius.circular(20),
                                        color: Colors.blue),
                                  ),
                                  SizedBox(
                                  ...
                                  Container(
                                    ...
                                    height: 80,
                                    decoration: BoxDecoration(
                                        image: DecorationImage(image: AssetImage("assets/orange.jpeg"),fit: BoxFit.cover),
                                        borderRadius: BorderRadius.circular(20),
                                        color: Colors.blue),
                                  ),
                                ],
                                ...
                                child: Column(
                                  children: [
                                    Container(
                                      ...
                                      height: 200,
                                      decoration: BoxDecoration(
                                          image: DecorationImage(image: AssetImage("assets/hotfd.jpeg"),fit: BoxFit.cover),
                                          borderRadius: BorderRadius.only(
