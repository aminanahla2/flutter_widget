...
class _AdminAddpageState extends State<AdminAddpage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(backgroundColor: Colors.blue[50],leading: IconButton(onPressed: () {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [Row(
                        children: [
                          Text("Enter Matter",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
                        ],
                      ),
                        TextFormField(
                          validator: (value) {
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [Row(
                        children: [
                          Text("Enter Content",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
                        ],
                      ),
                        TextFormField(
                          validator: (value) {
